...
export function DelimitedListField(props: DelimitedListFieldProps) {
  ...
  const lines = parseDelimitedList(rawValue);
  ...
  return (
    <Root className={props.className}>
          ...
          <TextInput
            ...
            style={{
              ...
              onChange={(event) => {
                ...
                commit(copy.filter(Boolean).join(delimiter));
              }}
            />
          <ActionCell>
            <InlineButton
      ...
      <InlineButton type="button" onClick={() => commit([...editableLines, ""].join(delimiter))}>
        Add Row
      </InlineButton>
    </Root>
  );
