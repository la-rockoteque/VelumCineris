...
→ Compare with working request in `/DNDBeyond/requests/spell.update.modifier.create.request.txt`
...
```bash
cat DNDBeyond/requests/spell.update.modifier.create.request.txt
```
