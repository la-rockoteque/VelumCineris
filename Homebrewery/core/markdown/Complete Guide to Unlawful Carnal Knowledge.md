<img style='position:absolute;width:100%;left:0px;top:0px'
  src='https://i.imgur.com/nyOktQ6.jpg'
  style='width:325px' />
...
<style>
@import url('https://fonts.googleapis.com/css?family=Dancing+Script|Gloria+Hallelujah|Shadows+Into+Light');
...
This Markdown edition preserves the original sourcebook's credited material
while reframing its game mechanics for the 2024 revision of D&D 5e and
repairing formatting introduced during conversion from plain text.
...
<div style='margin-top:140px'></div>
<img
  src='https://cdna.artstation.com/p/assets/images/images/010/611/442/large/nolan-lu-a-ywara-copy.jpg?1525320475'
  style='width:325px' />
Credit: Nolan Lu
...
- Using This Guide with D&D 5e
- Relationships, Fertility, Pregnancy, and Birth
- Seduction, Skills, Diseases, and Mental Effects
- Spells, Psionic Powers, and Magic Items
- Character Concepts and Establishments
- Encounters, Adventures, Essays, and Stories

<div class='pageNumber auto'></div>
\page
<div class='footnote'>LAST UPDATE: 01/01/96</div>
...
<div align='right'>---The Guide Creator</div>
...
This edition reframes the original system-neutral and AD&D-era material for the
2024 revision of the fifth edition rules. The material is optional homebrew.
The DM decides which sections exist in the campaign and can replace any roll
with a narrative outcome.

### Table Safety and Consent

This guide deals with adult relationships, pregnancy, disease, coercion, and
sexual violence. Before using it, establish boundaries with the group. Use
lines and veils or another safety tool, and fade to black whenever a player
requests it. Player characters and participating NPCs must be consenting
adults.

Magic never makes sexual contact consensual. Unless a spell explicitly says
otherwise, an effect that would compel sexual contact instead causes the
affected creature to become **Charmed** or **Frightened** as described by the
spell, and the effect ends immediately if anyone attempts sexual contact with
that creature. Such magic is generally villainous, illegal, and unsuitable for
player characters unless everyone at the table has explicitly agreed to its
inclusion.

### Core Resolution

Use the following rules whenever an older passage does not provide a complete
5e mechanic.

- **Ability checks.** The DM chooses the relevant ability and proficiency.
  Common examples include Charisma (Persuasion), Charisma (Performance),
  Wisdom (Insight), Intelligence (Arcana), and Wisdom (Medicine).
- **Difficulty Classes.** Use DC 10 for an easy task, DC 15 for a moderate
  task, DC 20 for a hard task, and DC 25 for a nearly impossible task.
- **Contests.** When two creatures directly oppose one another, both make the
  relevant ability check; the higher result wins. A tie preserves the current
  situation.
- **Saving throws.** References to a generic saving throw use a DC of
  `8 + the source's proficiency bonus + the source's relevant ability
  modifier`. Use Constitution for bodily effects, Wisdom for emotional or
  mental influence, and Dexterity for effects that can be physically avoided.
- **Percentile modifiers.** Replace each cumulative 5 percent modifier with a
  `+1` or `-1` modifier to a d20 roll. A percentile chance can instead be
  resolved directly with a d100.
- **Time.** A round is 6 seconds, a minute is 10 rounds, and a creature's turn
  is its opportunity to act during a round.
- **Long-term penalties.** Replace penalties to ability scores, attack rolls,
  or spell-failure chances with **Disadvantage** on the most relevant d20 Test.
  A particularly severe effect can also reduce Speed by 10 feet.
- **Damage and recovery.** Hit point damage represents immediate adventuring
  harm, not ordinary discomfort. Long-term medical effects are better modeled
  with Exhaustion or a condition chosen by the DM.

### Characters and Creatures

- **Species.** Older references to species mean species. Species does not grant
  ability score increases in this guide.
- **Classes and subclasses.** References to wizard mean wizard, cleric mean
  cleric, and thief mean rogue. Older class kits and subclasses are concepts,
  not complete player options, unless they provide features at the levels
  required by the chosen 2024 class.
- **Skills and proficiencies.** Nonweapon proficiencies and secondary skills
  become the closest 5e skill, tool, language, weapon, or armor proficiency.
- **Psionics.** A psionic power is magical for rules purposes. It uses the
  user's spell save DC or a DC of `8 + proficiency bonus + Intelligence
  modifier` if the user has no spell save DC.
- **Attitude.** Friendly, Indifferent, and Hostile NPC attitudes replace
  reaction rolls. Persuasion can influence an NPC, but it cannot override
  consent, deeply held beliefs, or impossible requests.

### Spells and Magic Items

The spells in this guide use the normal 5e spellcasting rules with these
defaults when a legacy entry is incomplete:

- A spell with a numeric casting time has a casting time of 1 action.
- A spell with a duration measured per caster level lasts 1 minute and
  requires Concentration if it hinders or controls another creature.
- A spell that says a saving throw negates its effect allows a Wisdom saving
  throw unless the effect is primarily physical, in which case it allows a
  Constitution saving throw.
- A spell attack is a melee spell attack for a touch effect and a ranged spell
  attack for any other effect.
- A creature knows when it was affected by a spell after the spell ends unless
  the spell says otherwise.
- Magic resistance means Advantage on saving throws against spells and other
  magical effects.
- Magic items use Attunement when they grant a persistent bonus, impose a
  curse, or reproduce a spell of 4th level or higher.

### Conditions Used by This Guide

When a legacy effect lacks a precise mechanic, use the closest standard
condition. Attraction and fascination usually impose **Charmed**; revulsion
and panic usually impose **Frightened**; incapacitating pleasure or pain
usually imposes **Incapacitated**. The DM should prefer a short duration with
repeat saving throws at the end of each of the affected creature's turns.

## THE WILD-THING RULES

> ##### 5e Procedure: Fade-to-Black Intimacy
> Use this optional procedure only when every participant wants a mechanical
> result. Each participating character makes a Constitution (Performance)
> check. A character can use Charisma instead if emotional connection matters
> more than endurance. On a 10 or higher, the character avoids an awkward or
> exhausting complication; on a 20 or higher, the character also grants one
> willing participant Inspiration. After the roll, fade to black. These checks
> never determine consent, attraction, or another character's response.
...
Some GMs may feel that certain species should be more adept at sex
than others. Many arguments can be made for every species. The one species
that most people feel should have modifiers is the dwarf species. However,
...
get +1), it is not necessary to give additional modifiers to species.

The following is the steps to go through to see if a character can
continue having sex:

- A character can initially last a minimum of rounds equal to his/her
...
- After the initial rounds pass, the character must make a
...
- A failed check means the character lost interest for whatever
reason.
...
| A. Score | Modifier |  |
| --- | --- | --- |
| 03-05 | -4 | <-- very charismatic |
| 06-08 | -2 |  |
| 09-12 | 0 |  |
| 13-15 | +2 |  |
| 16-18 | +4 | <-- totaly attractive |

## INTER-SPECIES FERTILITY

Amongst species, there are four varying breeding relationships
listed in Table A.
...
| Result | As per species |

| **Relationship** | **Similar** |
| --- | --- |
| Additional Requir. | None |
| Chance of Fertility | As the lesser fertile of the two species |
| Result | Half breed |
...
| Additional Requir. | None |
| Chance of Fertility | As the lesser fertile of the two species |
| Result | Produce pure breed of the species the size of the female (see below) |

| **Relationship** | **Different** |
| --- | --- |
| Additional Requir. | Magical or divine intervention |
| Chance of Fertility | 0% (without intervention) or 100% (with) |
| Result | Produce a new species that may be fertile and breed true |
...
#### TABLE C: Size
| Relationship | Species of Father | Species of Mother | Species of child |
| --- | --- | --- | --- |
...
There is one interesting exception, humans and halflings. While they are fertile with each other, such a pairing will only produce one or the other species. This may be because they are so similar that there can be no half breed species. Consult Table Cb.
...
For some specific species, the relationships are given on Table D.

#### TABLE D: Specific Species

| Species | Relationship | Examples |
| --- | --- | --- |
| **Centaur** | Similar | None |
|  | Related | Horse, Human. |
|  | Different | Most other species |
...
NOTE: The maximum age for each species was divided by 100. This number was divided into 100% to get the base chance (fractions rounded). This gives an accurate representation of how fertile an overall species is. If a GM wishes to add more species, all that would be needed is the maximum age of that species.
...
> ##### 5e Procedure: Pregnancy
> Pregnancy is normally narrative and does not change a character's combat
> statistics. When a dangerous event makes an outcome uncertain, use a
> Constitution saving throw by the pregnant character or a Wisdom (Medicine)
> check by a caregiver. Use DC 10 for routine strain, DC 15 for serious danger,
> and DC 20 for extreme danger. On a failure, prefer Exhaustion, a temporary
> condition, or a story complication over ability-score loss or automatic
> death. This is fantasy-game material, not medical guidance.
...
> NOTE: The length of pregnancy was derived from the assumption that an elf's pregnancy lasts 24 months and that the elves life span is 750 years. 750 divided by 24 yields the number 31.25. 31.25 was then divided into the life spans of all species to get the length of pregnancy with the exception of humans. Since human pregnancy in an RPG can have real-world basis, the length is given as 9 months. 14.44 (derived from dividing 130 by 9) could have been used rather than 31.25 but the 31.25 is based on the fantasy elf species and so that number was used for the other fantasy species. GMs may alter the list as they wish.
...
For those GM's who want to add a little spice to the pregnancy, Table 1b gives the chance of more than one child being born based on species. For example, a human has a 1 in 10 chance of having twins while a dwarf has a 1 in 100,000 chance of having twins. This can also be interrupted as 1 in 10 humans having twin sibling while 1 in 100,000 dwarfs have a twin sibling.
...
| Species | Twin | Trip | Quad | Quint | Sex |
| --- | --- | --- | --- | --- | --- |
...
- Lower constitution by an additional 1 for a total of -2 to constitution because of increased fatigue.
...
- Noticeable weight gain. Increase weight appropriate to species.
...
- Rogue-related ability checks Climb and Move Silently suffer a -5%.
- Disadvantage on Constitution saving throws made to maintain Concentration.

##### 5th Stage

- Check for mood swings for this stage at 35% chance.
- Check for morning sickness (05%).
- Weight gain. Increase weight appropriate to species.
- Food cravings.
- Lower dexterity by an additional 1 for a total of -2 to dexterity because of lack of agility.
- Rogue-related ability checks Climb and Move Silently suffer an additional -5%.
- Disadvantage on Constitution saving throws made to maintain Concentration.

##### 6th Stage

- Check for mood swings for this stage at 25% chance.
- Weight gain. Increase weight appropriate to species. Adjustment to armor size is likely and probably expensive.
- Food cravings.
- Lower dexterity by an additional 1 for a total of -3 to dexterity because of lack of agility.
- Rogue-related ability checks Climb and Move Silently suffer an added -1d10%.
- Disadvantage on Constitution saving throws made to maintain Concentration.
...
- Check for mood swings for this stage at 35% chance.
- Check for backache.
- Lower dexterity by an additional 1 for a total of -4 to dexterity because of lack of agility.
...
- Check for mood swings for this stage at 45% chance.
- Check for backache.
- Lower dexterity by an additional 1 for a total of -5 to dexterity because of lack of agility.
- Speed cut by half. Must rest triple the normal amount of times.
- Disadvantage on Constitution saving throws made to maintain Concentration.
...
- For a roll of 6 on Table 2, roll 1d6 again. A 1 indicates an obsessive behavior. Thus, she becomes obsessive about whatever the party is doing at the moment to the point of not letting anyone or thing in her way of trying to accomplish her goal.
...
A character has nausea if a constitution ability check is failed. A person with nausea feels like vomiting. The character has difficulty concentrating and therefore has Disadvantage on Constitution saving throws made to maintain Concentration. Furthermore, she suffers a -1 to dexterity and strength for the duration of nausea.
...
Some feel that there should be a charisma penalty imposed to a pregnant character. Supposedly, pregnant women find themselves fat, ugly, and undesirable. Thus, they don't give of an aura of coolness, magnetism, leadership, and determination. Not to many will follow a moody, weak woman. This "ugly" state would also be reflected in
attractiveness.

Others feel that a pregnant character should get a bonus to charisma. Supposedly, pregnant women "glow with motherhood". Being pregnant is the essence of womanhood and many males find this attractive. In fact, a pregnant woman can get people to wait on her beckon call because she seems so helpless. This "natural beauty" can be
...
A pregnant wizard or cleric can cause weird things to happen to an unborn child if she casts spells after the 2nd stage of pregnancy. Magic is the ability to shape, control, harness, and utilize natural forces that infuse the world and surround the character. When a wizard or cleric uses her magic ability, this force can influence the development of an unborn child.

Every time a wizard or cleric casts a spell after the 2nd stage of pregnancy, there is cumulative chance equal to the spell level that an effect has occurred.
For example, Roxanne The Wizard is in her 3 stage of pregnancy. She casts a 2nd level spell. There is a 2% that the unborn child is effected. The player rolls a 25 on the percentile dice and thus nothing happens to the unborn. Then, Roxanne casts a 3rd level spell. Now there is a 5% (2+3) chance of the unborn child to be effected. But the percentile dice show a 56 and the child is safe.
...
Going to the elemental planes gives a cumulative 5% chance of aneffect occurring.
Going to the ethereal plane gives a cumulative 25% chance that aneffect has occurred.

Going to the astral plane gives a cumulative 50% chance that aneffect has occurred because of the strain.
...
If any aging effect is inflicted upon the pregnant woman (such as a Haste spell), the aging effect is split between the mother and child equally. This, of course, may cause immediate labor and birth of the child. Due to increased development rate, the child must make a DC 15 Constitution saving throw based on its mother's constitution. Failure indicates that an effect occurs.
...
| 1: | Born with darkvision which enables child to see up to 60 feet in the dark. If the child's species already has the benefit of darkvision than add 20 feet to the range. |
| --- | --- |
| 2: | Born with a +1 bonus to all Constitution saving throw, poison, or death magic. |
| 3: | Born with a +1 bonus to all saving throw against magic items. |
| 4: | Born with a +1 bonus to all Constitution saving throw or polymorph. |
| 5: | Born with a +1 bonus to all Dexterity saving throw. |
| 6: | Born with a +1 bonus to all Wisdom saving throw. |
| 7: | Born with 10d10 - 5 % advantage on saving throws against spells and magical effects. |
...
| 1: | Born with a -1 penalty to all Constitution saving throw, poison, or death magic. |
| --- | --- |
| 2: | Born with a -1 penalty to all saving throw against magic items. |
| 3: | Born with a -1 penalty to all Constitution saving throw or polymorph. |
| 4: | Born with a -1 penalty to all Dexterity saving throw. |
| 5: | Born with a -1 penalty to all Wisdom saving throw. |
...
Normally, labor will occur 36+1d4 weeks after conception for humans, elves, and half-elves. Labor will occur 38-1d4 weeks after conception for dwarves and halflings.

### MISCARRIAGES

When a character suffers over 50% of total hit points in damage, there is a chance that she suffers a miscarriage based on how long she has been pregnant. For the first three stages (1,2,3) the chance of a miscarriage is 50%. For the second three stages (4,5,6) the chance of a miscarriage is 25% The woman has 3d4 hours to get to a cleric for a Cure Critical Wounds to save the child. Of course, the child must make a DC 15 Constitution saving throw based on its mother's constitution to survive. In the case of a miscarriage, there is a 25% of hemorrhaging. Hemorrhaging causes 3d6 points of internal damage to the character.
...
The chance for a successful birth is based on the following formula (use mom's stats): success % = DC 15 Constitution saving throw + (2 * Strength).

The GM has two options for an unsuccessful birth. Kind GMs can make the mother make a DC 15 Constitution saving throw/2. If she succeeds then the child makes a roll to check for failure on the table based on the following formula: (DC 15 Constitution saving throw/2) - 1 for each day premature. (NOTE: subtract 10% from the table for each day the child is premature.) This option gives the character and child a second chance.  A more sinister GM can
...
This spell enables the cleric to detect pregnancy in any creature. The cleric will also know the day of conception, stage of pregnancy, estimated day of birth, and gender of child.
...
Some parental wizards have created a few useful cantrips. Below is a list of them. They have a small description and should not need additional explanation.

<br> **Burp** - causes the infant to pass gas.
<br> **Create** Cheerios and Milk - creates a healthy portion of cereal w/ milk.
<br> **Gallager's Food to Mush** - transfers food to edible mush for infants.
<br> **Turn Toddler** - keeps a whinny kid at bay.
...
| 88-90 | 2d20+8 % advantage on saving throws against spells and magical effects. Roll ignoring any result above 87. |
...
| 12 | 2d20+8 % advantage on saving throws against spells and magical effects. |
...
If the child is not of a shapechanging species, it will never shapechange again.

If the child is of a shapechanging species, it will gain its shapechanging powers with the onset of puberty.
...
Probably the most popular topic of a new born child is its sex. Roll percentile dice to determine the species of the child. Generally the probability of having a female is slightly greater than a male. Thus there is a 52% of having a male and a 48% of having as female child. Note that GMs may wish to adjust this number in their campaigns for the various species. Also, the GM may let the character influence the chance one way or the other through magic, divine intervention, etc..
...
Note that the baby's attributes must still obey its species's minimum/maximum limits. For example, no human can be born with more than 18 or less than 3 in any attribute.


#### Height

To figure out what the baby's adult height will be, the first step is to average the parents height (in inches). Next, add the modifier based on species found on the height table below. Finally, add the adjustment found on the height table if it is a male, subtract the adjustment if it is a female. The result is the baby's adult height in inches.
...
To figure out what the baby's adult weight will be, the first step is to average the parents weight. Next, add the modifier based on species found on the weight table below. Finally, add the adjustment found on the weight table if it is a male, subtract the adjustment if it is a female. The result is the baby's adult weight.
...
- Companionship (though she would never agmit it to herself) * To gain greater powers and a sense of self away from Daddy * To get away from Daddy's immediate grasp so he doesn't marry her off to secure a trade agreement or something

**General:** She lives whim to whim. She has chronic PMS mood swings (aka The Bitch Rule). She is self serving. All of her likes and dis-likes are subject to change at any time, though a respect for books and talent and an attraction to jewelry are pretty consistent. She tends to dislike being dirty and loathes stupid people unless they have something she needs from them. She is a sort-of female Q (from Star Trek TNG). The party puts up with her often dangerous moods because
she is a really good wizard.**

**Adventure examples:** Has a casual but regular relationship with 'Irnar (a NPC wizard who "pops" in every now and again to stir up trouble with the characters). She keeps the relationship for what she can get out of him and because he learned some pretty INCREDIBLE moves after being abducted by a goddess of love. 'Irnar is totally into the physical aspect of a relation and since Salina is a wizard with the best atractiveness in my campaign, she wins out. Salina has been known to disappear (teleported by 'Irnar) during the middle of her night watch and reappear with melting snow in her hair. Or completely soaked with water, or in one case with grass stains and rope burns. The party has yet to find out what she does on her little side trips. One time she disappeared for three days then reappeared with no explanations, but she was in such a good mood that the party counted their blessings and did not press the questions. Besides, they desperately needed her since they were about to do battle with an Orcish army.

One time, another wizard in the party got Salina mad at him, so he cast a Globe of Invulnerability around him for protection. Salina, recognizing the spell promptly threw a dagger +2 at him as a "subtle way of saying "get out of my face" and continued on her way without losing hardly a beat.

Another time the party had to pay a toll of one magic item each to a very old black dragon (I was sorta hoping they'd try to fight the thing) and Salina, in her helpful, cheery mood promptly offered the other wizard to the dragon saying "If you let us pass, I'll give him to you" (note: said with a disgustingly cheery voice). The other wizard had to do some quick talking to get out of that one. He did get some help from the good cleric who was "appalled" that Salina could do such a thing.
...
In another adventure, the party was right in the middle of battling an awesome wizard (Le Morte by name) and Salina suddenly got bored and sat down to do her nails. The party, without a wizard to help them  out, really got whomped on, had to give in to Le Morte's demands, and lost a Horn of Dwarf Summoning they had spent several months (real time) trying to get in order to call the Dwarves to battle against the impending evil of a powerful anti-paladin (Sheol) who is still trying to take over all of the land.
...
| 0-70 | Man drops weapon, clutches privates, and loses next 1d4 roundsof initiative. |
| --- | --- |
| 71-80 | Man is blinded by tears and cannot defend or attack for the next1d6 rounds. |
| 81-90 | Man is stunned for one round and then goes into a berserker ragefor 1d10 rounds. Rules for berserk rage applies. |
...
| 99 | The character is Unconscious for 1d10 rounds. On a successful DC 15 Constitution saving throw, the character is Unconscious for only 1d4 rounds. |
| 00 | Man goes into shock, no save, and dies. All men within a viewingdistance must make a constitution save at -5 or they clutchthemselves and remain stunned for 1 round. |
...
> ##### 5e Procedure: Influence
> Seduction uses the normal social interaction rules. Begin with the NPC's
> attitude, roleplay the approach, then call for Charisma (Persuasion),
> Charisma (Deception), or Charisma (Performance) only when the outcome is
> uncertain. Wisdom (Insight) can reveal motives or boundaries. A successful
> check can improve attitude or secure a reasonable favor, but it never creates
> attraction, overrides refusal, or establishes consent.
...
Certain characters (see the subclasses in this guide) have a special benefit of seduction. This ability that differs from the seduction rules above is described here. Note that these rules are not gender specific but are given as if the Seducer is a woman.

The Seducer has a special power of seduction. Seduction is an ability which is used against individual males of the same or similar species as the Seducer. The Seducer's percentage chance of seducing is given by the following formula:

<div class='descriptive' align="center">
Seducer's level<br>
-----------  X 100<br>
...
| Skill | # of Slots Required | Relevant Ability | Check Modifier |
| --- | --- | --- | --- |
...
> ##### 5e Procedure: Diseases
> When exposure occurs, the creature makes a Constitution saving throw against
> the disease's DC, normally 10 to 15. On a failure, it contracts the disease
> after the listed incubation period. A creature can repeat the save after each
> Long Rest if the disease allows recovery. *Lesser restoration* or comparable
> magic cures an ordinary disease; magical diseases state any stronger cure
> they require. Use conditions and Exhaustion instead of daily ability-score
> loss.
...
>NOTE: not all settlements
have these many variations
of social level. The GM
should be aware of what
social levels are around.
...
\page
<div class='wide'>
| Social Level | TotalPop. | Sexual Active | Chance Of Dis. | Total Of Diseased |
| --- | --- | --- | --- | --- |
...
physical mode of locomotion and breathing as well. No DC 15 Constitution saving throw is
...
**Poison Secretion** - The sexual partner receives damage (Constitution saving throw)
...
victim must Constitution saving throw or be utterly unable to move. This
...
| 66-67 | Medectophobia | Contour of a penis which <br>is  visible through clothing |
...
| 81-85 | Penis Captivas | Having one's penis held <br>tightly be vaginal muscles |
...
<div align="right">&#149; can be specific type</div>
...
the clerics never need to explain their lack of interest in
...
men, among women, and among the various species, nations, and
occupations.
...
people's understandable reluctance to let wizards or clerics experiment
...
>Scholar, Sage, and Cleric of Deneir,
...
> ##### 5e Spell Conversion
> The spell entries below retain their original concepts and listed levels.
> Apply the spell defaults in "Using This Guide with D&D 5e" wherever an
> entry still uses legacy wording. Spells that compel intimacy instead impose
> the nearest appropriate condition and follow the consent rule. The DM should
> compare each spell with an official spell of the same level before allowing
...
- Don Juan's Irresistible Kiss
- Ecstasy
- Fascination
- Flash
- Freudian Thoughts
- Fyltar's Pheromonal Force
- Impotence
- Kiss of Charm
- Kiss Of Sleeping
- Kiss Of Wounding
...
- Homophobia
- Jealously
- Layla's Good Morning Kiss
- Kiss Of Weakness
- Neville's Wandering Hand
- Pornographic Glamer
- Protection From Intoxication
- Sexify/Enhance Comeliness
- Sleep Theft
- Transfer Charm
- Vampiric Kiss
- Voyeur
...
- Leomund's Tiny Brothel
- Sacremon's Emperor's New Clothes
- Sex Slave
- Stanza's Diseased Kiss
- Obsession
- Prowess
...
- Stanza's Certain Enchanted Kiss...
...
- Heartbreaker
- Kiss Of Death
- Stanza's Kiss of Immortal Despair
- Summon Cissaldan
...
- **Duration:** Concentration, up to 1 minute
- **Casting Time:** 1 action
- **Target:** 1 creature per 2 rounds
- **Saving Throw:** See description
- **Variant:** Reversible
...
two full rounds. A creature is allowed a Wisdom saving throw and, if
...
- **Casting Time:** 1 action
- **Target:** 10" X 3" (rumor has it that Mordenkainen
...
cheek. Creatures must Wisdom saving throw or be distracted for one segment,
...
only wizards have such a simplistic form of birth control.
...
three levels of the wizard to charisma with respect to having sex. Thus,
this spell won't effect any other aspects of charisma; only sex.

Most wizards cast the cantrip on his/her partner, so the partner is
more desirable thus making it easier for the wizard to perform.

The reverse of this cantrip is Sexual Disgust. The modifier is -1
for every three levels of the wizard rather than +1.
...
uncovered by armor. Victim's who are spellcasters must either saving throw against spell or make an Intelligence check to avoid losing concentration.
...
- **Components:** V, S
- **Duration:** till the wizard is done
- **Casting Time:** 1 action
- **Target:** obvious
- **Saving Throw:** See description
...
The person receives a Wisdom saving throw to avoid the effect, with any
...
- **Casting Time:** 1 action
- **Target:** 1d4+4 men of 3 HD/level or lower
- **Saving Throw:** See description

This spell is used by witches and houris, but other clever wizards
...
the area of effect must attempt a Wisdom saving throw. A successful save
...
and will appear to anyone without darkvision as lavender. The creature
being scried must be alive and visible to the caster. The method of
sight -darkvision, scrying, clairvoyance, etc. - does not matter.
...
combat). The wizard is in control and can decided how long to kiss. After
the kiss, both the wizard and the victim are stunned for 1 segment per
round of kissing.
...
follow the wizard wherever she/he goes, unable to take his/her eyes off
...
order to continue moving towards the wizard.
...
- **Duration:** Concentration, up to 1 minute
- **Casting Time:** 1 action
- **Target:** 1 creature per level of the caster
- **Saving Throw:** See description
...
to a maximum of 1d3+20 points. Those successfully saving throw against the spell
receive half damage.
...
gain a +2 modifier for every three levels of the wizard to dexterity with
...
the muscles in that area were clenched like a vise. The subject has
Disadvantage on attack rolls, ability checks, and saving throws for the
duration. On a successful saving throw, the subject instead has
Disadvantage only on Constitution and Charisma ability checks.
...
- **Casting Time:** 1 action
- **Target:** One person (4 HD/levels or less)
- **Saving Throw:** See description
...
better chance of Wisdom saving throw, tones the power down a bit, and makes
...
be successful. Fighters need a 13 to save, rogues need a 12, wizards need
...
extent that they will ignore the wizard or any other source of danger
present and quarrel amongst themselves. There is a chance equal to the
wizard's intelligence of such an argument leading to blows and, if it
does, there is an additional chance equal to the wizard's intelligence of
...
first victim: Neville, high cleric of Torm, who suddenly found himself
...
- **Duration:** Concentration, up to 10 minutes
- **Casting Time:** 1 action
- **Target:** Within a 10'x10' vertical square
- **Saving Throw:** See description
...
| Caster's Level | Comeliness | Duration |
| --- | --- | --- |
| 01 | 14 | 10 minutes |
| 02 | 15 | 20 minutes |
| 03 | 16 | 30 minutes |
...
Note that if two wizards cast the spell on a person simultaneously,
...
*2nd-level alteration, necromancy*
___
- **Range:** Touch
- **Components:** S
- **Duration:** Special
...
wizard casts Charm Person on a Bryce, who becomes charmed. Anna, a third
level wizard casts Transfer Charm onto Bryce, whereupon Bryce becomes
Charmed to Anna. However, Deneira, another third level wizard, cannot
...
wizard. The material component of the spell is a small piece of cloth and
...
- **Casting Time:** 1 action
- **Target:** 15-foot-diameter sphere
- **Saving Throw:** None
...
#### Angel's Negation
*4th-level enchantment, abjuration*
___
- **Range:** Touch
- **Components:** S
- **Duration:** Permanent
...
#### Layla's Sexy Kiss of Insanity
*4th-level enchantment, necromancy*
___
- **Range:** Touch
- **Components:** S
- **Duration:** Permanent
...
wizard that as soon as she/he loses sight of the wizard, the victim begins
...
What's more, if the wizard tells her/him to go away, she/he is compelled
...
#### Conjure Succubus/Incubus
*6th-level conjuration, summoning, necromancy*
___
- **Range:** 0
- **Components:** V, S
- **Duration:** Special
...
Constitution saving throw. Failing this save permanently reduces the
...
the wizard. This spell is always popular amongst Necromancers.
...
\page
#### Sex Change
*6th-level alteration, evocation*
___
- **Range:** 5 yards/level
- **Components:** V, S, M
...
female and visa-versa. A Wisdom saving throw negates the effects. After the
...
#### Layla's Seductive Shapechange
*7th-level alteration, divination*
___
- **Range:** 10 yards/level
- **Components:** V, S
- **Casting Time:** Special
...
attempt seven, she finds that Alex the wizard would really like a six-
...
Dexterity saving throw, with a -2 penalty, or drown instantly.  If
...
*9th-level alteration, necromancy*
___
- **Range:** Touch
- **Components:** S, M
- **Casting Time:** 1 action
...
level than the wizard who inflicted the disease. While the victim suffers
...
Below is some spell ideas that creative (boarding on sick) wizards
...
- Finger of Death
- Kiss of Strength
- The All New Bybig's Forceful Hand
- The All New Bybig's Grasping Hand
- The All New Bybig's Playful Hand
- Tongues ReErection Unseen Sexual
...
Most of the wizard spells elsewhere in the guide can be easily
...
#### Baltasar's Impediment
*1st-level necromancy, abjuration*
- **Range:** Touch
- **Components:** V, S, M
- **Duration:** Special
- **Casting Time:** 1 round
- **Target:** 1 (female) mammal
- **Saving Throw:** None
...
been mixed with dust and dried in a silver chalice) and the cleric's
holy symbol. The cleric invokes the name of his deity, touching his
...
#### Fertility
*4th-level alteration, necromancy*
___
- **Range:** 10 yards/level
- **Components:** V, S, M
- **Duration:** Special
...
| Species | Base Chance | Constitution | Modifier |
| --- | --- | --- | --- |
| Dwarf | 22% | 01-03 | -6% |
| Elf | 13% | 04-06 | -4% |
| Gnome | 20% | 07-09 | -2% |
...
of the clerics of Helm, Torm, and Tyr. This spell compels those within
its range to engage in sexual activities with wild abandon with anyone
else within the zone. Those within may individually saving throw against petrifaction at -5 to stave off the effects, but must save again if
...
<div class='descriptive' text-align='center'>
...
> ##### 5e Psionic Powers
> Treat each power in this section as a magical action. A creature using one must spend a spell slot of the power's listed level, or one use of an equivalent limited-use feature. Its save DC follows the psionics rule in "Using This Guide with D&D 5e."
...
must Constitution saving throw in order to keep functioning and fighting.
...
creature in the area must Constitution saving throw or desperately try to
...
times his Constitution score he must Constitution saving throw (with a penalty
...
> ##### 5e Magic Items
> Unless an entry says otherwise, a persistent or cursed item requires
> Attunement. Use the wielder's spell save DC for an item's saving throw, or DC
> 13 if the wielder has no spell save DC. Consumables and novelty items usually
...
#### Basque of Transvestitism -
 Any male wearing this garment appears to be
a female of the same species with identical stats. Any female character
can automatically see through this illusion, but males have to make
Wisdom rolls to realise something is wrong.

#### Boo-Hag Goggles -
 These goggles make everyone look much more sexually
attractive to the wearer than they really are.

#### Breast Plate +1 -
 This piece of armor gives the wearer a +1 bonus to
...
substance referred to by wizards as Silicon.

#### Earring(s) of Androgyny -
 These earrings make it impossible for anyone
to discern the gender of the wearer, even if naked.

#### Everful Baby Bottle -
 This baby bottle always contains milk. The milk
...
#### Figurine Of The Willing WonTon -
 This appears as a tiny (an inch or so
...
#### Frictionless Sheets -
 These covers seem like any other silk sheets, but
...
#### Gem of the Vo Yure -
 These finely cut and polished stones are
...
#### Girdle of Speedy Gestation -
 This girdle reduces the term of pregnancy
and labor to 1/10th of normal, with no ill effects to bearer or baby.

#### Girdle of Hippolyte -
 This is really a thin metallic chain one wears
...
#### Hourglass of Parietals -
 This typical hourglass compels sexual
...
#### Jackknife of Circumcision -
 A magical device used in the initiation
rites of certain mythos, which functions as a Knife +2 in the hands of
a circumcised male.

#### Ladies' Glass Ball -
 A glass ball containing a green substance hangs
...
#### Lipstick Of The Houri -
 This lipstick gives its wearer a limited kiss
...
#### Marishars Miraculous Bath House -
 This one square inch marble block is
...
the same species and opposite gender, with 18 charisma and 18 comeliness.
...
#### Morgaine's Chainmail Bikini -
 As a fashion conscious adventurer,
...
#### Parents SoloPlay Cursed Item -
 This cursed item can be anything but
...
goodie cleric or wizard to ensure "spiritual purity". When the possessor
...
#### Penis of Astounding -
 This is a 12' long artificial penis. It is used
...
all possessors must check a DC 15 Constitution saving throw or lose the fertility.

#### Perfume/Musk Of Attraction -
 This liquid increases the wearer's
charisma by 1 point. The duration is 1d20 hours. The liquid comes in a
small bottle with 2d20 applications.

#### Philter of Love -
 As in the DMG page 144, with the following revision:
...
#### Phylactery of Prophylactics -
 A phylactery with 1d6 detachable beads,
each one of which functions as a Contraception spell (see guide).

#### Potion of Aphrodisia -
 Functions as Obsession spell (see guide)
directed towards next person seen by the imbiber, regardless of the
viewed person's gender.

#### Potion of Potency -
 Functions as Prowess spell (see guide), for 6
hours.

#### Rahasia's Whirlpool Tub Of Love -
 Legend states that this enchanted
whirlpool tub was created by Rahasia, Wizard Priestess of Ishtar, The
...
Some clever clerics and wizards have created gems that cause the same
effects as the whirlpool tub when they are placed in a small body of
water.

#### Ring Of The Bulls -
 This regular ring is engraved with a bull head.
...
#### Ring of Sexuality Detection -
 A very simple ring with a white,
...
successful Wisdom check will alert them to the purpose - but not necessarily the source - of the scrutiny.
...
#### Sheet Of Useful Toys -
 This appears to a normal sheet adorned with
...
#### Spectacles of Revealing -
 While wearing these, the wearer sees everyone
as though they were absolutely naked.

#### Sword Of Castration -
 This weapon has a +2 bonus to hit and damage. The
...
#### Teeny-Weeny Bikini -
 This object, when worn, will shrink upon command
...
#### Underwear Of Virginity -
 This underwear is very popular among
...
#### Wand of Elenora's Embarrassment -
 The apprentice wizard Elenora's
...
#### Wand Of Love -
 This wand is very thin, white, and has a lightning star
in one point. Anyone struck by the star ('to hit' roll required) must
Wisdom saving throw or fall madly in love with the wand possessor. This love
...
#### Wand of Pillows -
 A normal looking wand which produces pillows. Here is
...
#### Wand Of Vibration -
 This wand has a small dial at one end. In magical
...
These arrows are the work of 'Irnar the chaotic wizard (protege
...
opposite sex of the same species to meet his/her gaze and feel compelled
...
sex and same species, and will make every attempt to do so.

<br>
12) The victim feels the "urge to merge" a living creature of the
opposite sex and same species, and will make every attempt to do so.
...
| 1-5 | same species as parent |
| --- | --- |
| 6-9 | other common species (elf, human, dwarf, halfling, etc.) |
| 10 | Demon |
...
that inflicts 10d6 points of damage upon contact. A successful saving throw against spell reduces the damage to half (round fractions down).
...
## HOURI: WIZARD CHARACTER CONCEPT

> ##### 5e Implementation
> This legacy kit is presented as a character concept, not a selectable 2024
> subclass. Build it with the named class, the Entertainer or Wayfarer
> background, Charisma-based skills, and suitable feats and spells. Ignore
> ability-score prerequisites, alignment restrictions, reaction modifiers,
> barred schools, percentage skill adjustments, and gender or species
> restrictions. No feature can override consent.
...
made for men and thus a Gigolo wizard subclass is born). Furthermore,
...
## SEDUCER: WIZARD CHARACTER CONCEPT
...
contact with him must Wisdom saving throw at a penalty equal to the
...
**RACES:** A Seducer can theoretically be any species, although most GMs would
probably prefer to limit it to humans, elves and half- elves.

## SEDUCTRESS: ROGUE CHARACTER CONCEPT
...
Seducer/Seductress wizard does it for professional pleasure, but the
rogue Seductress does it for the wealth.

The Seductress is a female rogue who uses her special abilities of
seduction to get what she wants. Unlike the wizard Seductress who is in
...
wizard Seducers. They usually go out of their way to make life difficult
...
**RACES:** A Seductress can theoretically be any species that can be rogues,
...
## PSIDUCER: PSIONIC CHARACTER CONCEPT
...
ability to for pleasure and power. Like the wizard seducer, the Psi-
...
what the Gigolo subclass is all about.
...
2) Choose an appropriate species in respects to the environment (i.e.
...
The last adjustment is made based on the species of the prostitute.
...
| --- | --- | --- | --- | --- |
| **Species** | **Base*** | **Modifier** | **Base*** | **Modifier** |
...
#### TABLE 4: Color Stats.
| Die Roll | Hair Color | Eye Color | Complexion |
| --- | --- | --- | --- |
...
| Die Roll | Inclination | Adjustment |
| --- | --- | --- |
| 01 | Loathe | + 100% |
| 02 | Hate | + 75% |
| 03-04 | Dislike | + 50% |
...
house of its class is given on Table 2; one may either specify the species
...
<div class='pageNumber auto'></div>
\page
#### TABLE 2: Species Found In Different Classes
| Species | Fine | Normal | Low | Slave |
| --- | --- | --- | --- | --- |
...
healing for the love of mankind (or any other species, for that matter).
...
Elf Female 5th Level Cleric of the elven goddess of love and beauty
...
Skill and Tool Proficiencys: Singing, Dancing, Religion, Healing, Seduction,
...
Role-playing notes: The cleric must always give shelter and succor to
young lovers.
...
Skill and Tool Proficiencys: Blind Fighting, Dancing, Religion, Healing,
...
1) Roll 2d10 on a Table 1 to get the species that created the periodical.
...
Demons and monstrosities populate this plane by the
...
will become so strong that they will stop what they are doing and species
...
rape nothing more than a different form combat? When one person
...
><div align='right'>--- John Daniel</div>
...
The group of us (myself a monk, a fighter, cleric, and wizard) were
...
<div align='right'>--- Toa the monk</div>
...
<div align='right'>--- Mario R. Borelli</div>
...
elven female wizard (played by a male) had a certain sudden
...
with a low level barbarian and a mid-level wizard going at it) the GM had
asked questions and rolled his dice and wouldn't ya just know that the
wizard got pregnant (snicker).
...
wizard doesn't really know she's pregnant yet).
...
(The other me is a holly-ghost, an undead lawful-good cleric of the God
...
vampire wizard to cast stone-to-flesh on me. He did that three times,
'cause I failed the DC 15 Constitution saving throw twice... So, and here we get to our
...
Multiple Orgasm). The local dominant species, the Salbars, can (and do)
...
<div align='right'>--- Luwain</div>

### A Cleric's Vow ---

I've been in a party with a very complex character. He was a
powerful cleric, who had entered priesthood as a sort of escape from
...
could help him was a evil female wizard who found him, and his resistance
...
older woman, and due to Lady Rebecca's strong personality (saving throw against charm with a +4 bonus). I also learned that Rebecca was something of a
...
<div align='right'>--- Kenneth Nuckols</div>
...
Lonadar the Wanderer bringing up the species question, commenting on a lot
...
Vinnie & Rahasia Wizard Priestess of Ishtar The Priestess of Love for
...
What would pregnancy do to a theif's skills? What about a wizard or
