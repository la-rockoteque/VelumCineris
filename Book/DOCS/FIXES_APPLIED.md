...
**Files Modified:**
- `Book/core/formatters/species.py`
- `Book/core/formatters/monsters.py`
...
**Problem:** Error in `FiveETools/core/fantasy/species.py` line 51
...
**Location:** `FiveETools/core/fantasy/species.py:51`
...
**Problem:** Error in `FiveETools/core/fantasy/monster.py` line 121
...
**Location:** `FiveETools/core/fantasy/monster.py:121`
...
1. **Fix Species Converter** (`FiveETools/core/fantasy/species.py`):
   ```python
...
2. **Fix Monster Converter** (`FiveETools/core/fantasy/monster.py`):
   ```python
...
- `FiveETools/core/fantasy/species.py` - Line 51 (float subscript error)
- `FiveETools/core/fantasy/monster.py` - Line 121 (int parsing error)
